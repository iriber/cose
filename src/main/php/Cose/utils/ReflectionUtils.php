...
class ReflectionUtils{
	...
	/**
	 * Se obtienen los comentarios del m�todo
	 * $method viene dado por __METHOD__ que tiene nombreClase::nombreMetodo
	 * @param unknown_type $method
	 * @return string comentarios
	 */
	public static function getCommments( $method ){

		//split para el nombre de la clase y m�todo.
		$clazzAndMethod = explode("::", $method);
		
		$reflectionMethod = new \ReflectionMethod( $clazzAndMethod[0] , $clazzAndMethod[1]);
